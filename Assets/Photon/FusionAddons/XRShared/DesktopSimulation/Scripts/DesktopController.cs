...
namespace Fusion.XR.Shared.Desktop
{
     ...
     */
    public class DesktopController : MonoBehaviour, ISimulatedRigComponent
    {
#if ENABLE_INPUT_SYSTEM
        public InputActionProperty forwardAction;
        public InputActionProperty rotationAction;
#endif
        public IMovableHardwareRig rig;
        ...
        void Update()
        {
            ...
            if (rotationAction != null && rotationAction.action != null)
            {
                rig.Rotate(rotationAction.action.ReadValue<float>() * Time.deltaTime * rotationSpeed, addSnapMovementVisualProtection: false);
            }
        ...
        {
            rig.Teleport(newPosition, addSnapMovementVisualProtection: false);
        }
