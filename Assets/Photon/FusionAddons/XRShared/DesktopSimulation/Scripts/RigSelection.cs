...
namespace Fusion.XR.Shared.Desktop
{
    ...
    public class RigSelection : MonoBehaviour, IRigSelection
    {
        ...
        public bool IsVRRigSelected => vrRig != null && vrRig.isActiveAndEnabled; 
        ...
        public GameObject vrRigGameObject;
        public GameObject desktopRigGameObject;
        public IHardwareRig vrRig;
        public IHardwareRig desktopRig;
        ...
        private void Awake()
        {
            ...
            if (vrRigGameObject)
            {
                vrRig = vrRigGameObject.GetComponent<IHardwareRig>();
                if (vrRig == null) Debug.LogError("Missing IHardwareRig in VRRig");
                vrRigGameObject.SetActive(false);
            }
            if (desktopRigGameObject)
            {
                desktopRig = desktopRigGameObject.GetComponent<IHardwareRig>();
                if (desktopRig == null) Debug.LogError("Missing IHardwareRig in DesktopRig");
                desktopRigGameObject.SetActive(false);
            }
