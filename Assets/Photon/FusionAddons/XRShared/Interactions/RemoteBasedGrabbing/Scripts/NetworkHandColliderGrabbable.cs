...
namespace Fusion.XR.Shared.Grabbing.NetworkHandColliderBased
{
    ...
    public class NetworkHandColliderGrabbable : NetworkBehaviour
    {
        ...
        public override void Render()
        {
            ...
            Follow(followedTransform: CurrentGrabber.rigPart.transform, LocalPositionOffset, LocalRotationOffset);
        }
        ...
        void ExtrapolateWhileTakingAuthority()
        {
            ...
            Follow(followedTransform: grabberWhileTakingAuthority.rigPart.transform, localPositionOffsetWhileTakingAuthority, localRotationOffsetWhileTakingAuthority);
        }
